            ...
            <div className="card vertical-center">
                <div className="card-body">
                    ...
                    <ul className="rules" style={{listStyleType: "disc", textAlign: "left"}}>
                        <li><h3 className="game-title">All cards have a 30% chance in turning into an explosive mine</h3></li>
                        ...
                        <li><h3 className="game-title">The 4th card has a higher chance of turning into an explosive mine (50% XD).</h3></li>
                        <li><h3 className="game-title">Player who gets to 5 points first will win the game.</h3></li>
                    </ul>
                    </div>
